...
<div class="card text-center" style="width: 77%">
  <div class="card-header nombre-elements" style="text-align: center;">
    Documents uploader par :<strong>  {{ $user->nom }}</strong>
  </div>
  ...
  <div class="card text-center">
    ...
    <div class="card-body">
      ...
      <div  style="width: 18rem;">
        ...
        <div class="card-body">
          <h5 class="card-title"><strong>{{ $user->nom }}</strong></h5>
  ...
  <div class="card-body search-list">
    <table class="table">
      ...
      <caption>Aucun Document</caption>
      @else
      <caption>Documents uploadé par :{{ $user->nom }}</caption>
      <thead>
        <tr>
          <th scope="col">Nom</th>
